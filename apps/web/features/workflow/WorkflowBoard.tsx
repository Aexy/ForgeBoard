...
import { WorkflowDragCard } from './WorkflowDragCard'
...
export function WorkflowBoard({ workflowSlug, basePath }: Readonly<{ workflowSlug: string; basePath: string }>) {
  ...
  const [message, setMessage] = useState(''); const [newStageId, setNewStageId] = useState<string | null>(null); const [expandedStageIds, setExpandedStageIds] = useState<string[]>([])
