...
public class Engagement {
    ...
    public Engagement(UUID id, UUID firmId, UUID templateId, UUID clientId, UUID workflowId,
        ...
        this.workflowId = workflowId; this.periodStart = periodStart; this.periodEnd = periodEnd;
