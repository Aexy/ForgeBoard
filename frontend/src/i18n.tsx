...
const german: Record<string, string> = {
  ...
  'Select reviewer': 'Prüfende Person auswählen',
  ...
  'Filter by client': 'Nach Mandant filtern',
  'Filter by owner': 'Nach verantwortlicher Person filtern',
  'Filter by due state': 'Nach Fälligkeitsstatus filtern',
  'Filter by priority': 'Nach Priorität filtern',
  'Show unassigned work': 'Nicht zugewiesene Aufgaben anzeigen',
  'Reset filters': 'Filter zurücksetzen',
  'Saved view': 'Gespeicherte Ansicht',
  'Apply saved workflow view': 'Gespeicherte Arbeitsablaufansicht anwenden',
  'Apply saved view': 'Gespeicherte Ansicht anwenden',
  'Delete saved workflow view': 'Gespeicherte Arbeitsablaufansicht löschen',
  'Delete saved view': 'Gespeicherte Ansicht löschen',
  'Save shared view': 'Geteilte Ansicht speichern',
  'Shared view name': 'Name der geteilten Ansicht',
  'Save view': 'Ansicht speichern',
  'Drop work item here': 'Aufgabe hier ablegen',
  'In progress': 'In Bearbeitung',
  'Normal flow': 'Normaler Ablauf',
  ...
  'Pick up where your team left off.': 'Machen Sie dort weiter, wo Ihr Team aufgehört hat.',
  'Create the first owner account for your firm.': 'Erstellen Sie das erste Inhaberkonto für Ihre Firma.',
  '12 characters minimum': 'Mindestens 12 Zeichen',
  'ForgeBoard gives accounting teams one calm, accountable place to run deadlines, handoffs, and recurring work.': 'ForgeBoard bietet Buchhaltungsteams einen ruhigen, nachvollziehbaren Ort für Fristen, Übergaben und wiederkehrende Arbeit.',
  'One view': 'Ein Überblick',
  'of every active engagement': 'über jeden aktiven Auftrag',
  'Clear ownership': 'Klare Verantwortung',
  'from preparation to review': 'von der Vorbereitung bis zur Prüfung',
  'Audit ready': 'Prüfungsbereit',
  'with every change recorded': 'mit jeder Änderung erfasst',
  'Tenant-isolated and audit-ready by design': 'Mandantengetrennt und von Grund auf prüfungsbereit',
  'Account access': 'Kontozugang',
  'Workspace address': 'Adresse des Arbeitsbereichs',
  'Show password': 'Passwort anzeigen',
  'Hide password': 'Passwort verbergen',
  "Don't have an account?": 'Noch kein Konto?',
  'Already have an account?': 'Haben Sie bereits ein Konto?',
  'Create a firm from sign-in': 'Firma über die Anmeldung erstellen',
  'Sign in from firm creation': 'Über die Firmenerstellung anmelden',
}
