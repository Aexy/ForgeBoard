...
- Recorded Next browser-parity evidence for the persisted EN/DE selector across public sign-in, firm deep links, reloads, and workflow task interactions. (`M2`)
